...
<footer class="page-footer font-small unique-color-dark" style="background-color: #26003D; color:white;">
    ...
    <div class="container">
      ...
      <div class="row py-2 d-flex align-items-center">
        ...
        <div class="col-md-6 col-lg-5 text-center text-md-left">
          <h6 class="mb-0 font-weight-bold" style="color: snow;"> ¡Mantente en contacto con nosotros!</h6>
        </div>
        <!-- Grid column -->
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
        ...
        <!-- Content -->
        <h6 class="text-uppercase font-weight-bold">Kiwi Dreamers</h6>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <p>
          <i class="fas fa-envelope mr-3"></i> Info@KiwiDreamers.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> (+503) 72010315 </p>
        <p>
          <i class="fas fa-print mr-3"></i> 2382-2908 </p>
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3">©<?php echo date("Y"); ?> Copyright KiwiDreamers.com 
